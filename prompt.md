...
1. Read the PRD at `{{PROJECT_DIR}}/prd.json`
2. Read the progress log at `{{PROJECT_DIR}}/progress.txt` (check Codebase Patterns section first)
...
10. Append your progress to `{{PROJECT_DIR}}/progress.txt`
